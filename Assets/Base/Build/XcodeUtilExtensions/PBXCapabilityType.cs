...
#endif
{
    ...
    public class iOSCapabilityTypeHelper
    {
        public static PBXCapabilityType GetPBXCapabilityType(iOSCapabilityType iOSCapabilityType)
        {
            switch (iOSCapabilityType)
            {
                case iOSCapabilityType.ApplePay:
                    return PBXCapabilityType.ApplePay;
                case iOSCapabilityType.AppGroups:
                    return PBXCapabilityType.AppGroups;
                case iOSCapabilityType.AssociatedDomains:
                    return PBXCapabilityType.AssociatedDomains;
                case iOSCapabilityType.BackgroundModes:
                    return PBXCapabilityType.BackgroundModes;
                case iOSCapabilityType.DataProtection:
                    return PBXCapabilityType.DataProtection;
                case iOSCapabilityType.GameCenter:
                    return PBXCapabilityType.GameCenter;
                case iOSCapabilityType.HealthKit:
                    return PBXCapabilityType.HealthKit;
                case iOSCapabilityType.HomeKit:
